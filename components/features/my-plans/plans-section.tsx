...
export function PlansSection({ onSectionChange }: PlansSectionProps) {
  ...
  const currentPlan = {
    ...
    price: MOCK_PLAN_DATA.price,
    period: MOCK_PLAN_DATA.period,
    features: t.raw('plans.basic.features') as string[],
    status: MOCK_PLAN_DATA.status,
    nextBilling: MOCK_PLAN_DATA.nextBilling
  }
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-white/70">{t('currentPlan.status')}: <span className="text-green-400 font-semibold">{t('currentPlan.active')}</span></p>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{MOCK_PLAN_DATA.cvsCreated}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{MOCK_PLAN_DATA.templatesUsed}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{MOCK_PLAN_DATA.daysRemaining}</div>
