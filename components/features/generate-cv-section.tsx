...
import { FiFileText, FiUpload, FiDownload, FiEdit3, FiZap } from "react-icons/fi"
  ...
  return (
    <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
      ...
      <div className="flex items-center space-x-3 mb-4 lg:mb-6">
        ...
        <div>
          <h1 className="text-lg lg:text-2xl font-bold text-white">Gerar CV com IA</h1>
          <p className="text-white/70 text-sm lg:text-base hidden sm:block">Crie um currículo profissional usando inteligência artificial</p>
        </div>
      </div>
